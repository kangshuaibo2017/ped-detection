...
train_annotation_dir = "/hdd/ll/yolov3_spp/my_yolo_2007_dataset/train/labels"
val_annotation_dir = "/hdd/ll/yolov3_spp/my_yolo_dataset/val/labels"
...
def main():
    ...
    train_txt_path = "data/my_train_2007_data.txt"
    ...
    create_data_data("./data/my_0712_data.data", classes_label, train_txt_path, val_txt_path, classes_info)
